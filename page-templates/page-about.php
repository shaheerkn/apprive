...
<section class="hero hero-modifier">
  <div class="hero__img">
    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/about-hero-winter.jpg" alt="" class="for-winter">
    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/about-summer-hero.jpg" alt="" class="for-summer">
  </div>
...
<section class="breadcrumb single-chalet__breadcrumb breadcrumb__mobile-hide">
  <div class="container single-chalet__links">
    ...
    <a href="#" class="breadcrumb__current">About Us</a>
  </div>
</section>
...
<section class="about-intro section">
  <div class="container">
    ...
    <div class="about-intro__gallery">
      <figure class="about-intro__image-wrapper about-intro__image-wrapper--primary">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/about-intro-primary-winter.jpg" alt="Luxury Winter Cabin" class="for-winter">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/about-intro-primary-summer.jpg" alt="Luxury Winter Cabin" class="for-summer">
      </figure>

      <figure class="about-intro__image-wrapper about-intro__image-wrapper--secondary">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/about-intro-secondary-winter.jpg" alt="Luxury Summer Villa" class="for-winter">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/about-intro-secondary-summer.jpg" alt="Luxury Summer Villa" class="for-summer">
      </figure>
    </div>
...
<section class="brand-pillars section">
  <div class="container">
    ...
    <div class="brand-pillars__grid">
      <article class="brand-pillars__item">
        <div class="brand-pillars__icon">
...
<section class="founder-note section">
  <img src="<?php echo get_template_directory_uri(); ?>/assets/images/about-watermark.svg" alt="" class="founder-note-watermark">
  <div class="container">
    <div class="founder-note__content">
      <svg width="40" height="37" viewBox="0 0 40 37" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M30.303 37H20.6061V0H40L30.303 37Z" fill="black"/>
        <path d="M9.69697 37H0V0H19.3939L9.69697 37Z" fill="black"/>
      </svg>

      <h4 class="section-title">A note from our founder</h4>

      <div class="founder-note__body">
        <p>AR Privé was born from my personal journey in luxury hospitality and travel, where I had the privilege of working closely with international clients, property owners and trusted partners over the years.</p>
        <p>During this time, I realised that true luxury is rarely about excess. It is about feeling understood, welcomed and cared for without needing to ask.I created AR Privé to offer a more personal and thoughtful way of travelling, built on genuine relationships, careful selection and attention to the details that make every stay feel effortless.</p>
        <p>My vision has always been simple. To help clients experience destinations in a way that feels private, seamless and truly memorable.</p>
      </div>
