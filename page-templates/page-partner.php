  ...
  <div class="container">
    ...
    <div class="partner-services__grid">
      <article class="partner-services__item">
        ...
        You work with a dedicated partnership advisor who protects your property’s interests and keeps communication efficient
        and private.
        </p>
      </article>
      ...
      <article class="partner-services__item">
        ...
        <h5 class="partner-services__title">A Curated Guest Match</h5>
        <p class="partner-services__description">
        We select only vetted travellers that suit your home’s standards — ensuring respectful use and a high-quality stay.
        </p>
      </article>
      ...
      <article class="partner-services__item">
        ...
        <h5 class="partner-services__title">On-Site Hospitality & Care</h5>
        <p class="partner-services__description">
        Our local hosting teams supervise arrivals, services, staffing and property etiquette — delivering 5-star care without
        disrupting the home’s privacy.
        </p>
      </article>
    </div>
  </div>
