...
<footer class="footer">
    <div class="container">
      <?php $partners = get_field('partners_logos', 'option'); ?>

      <!-- Nav columns -->
      <div class="footer__nav">
        <!-- Column 1: Logo + Follow Us + Socials -->
        <div class="footer__nav-col footer__nav-col--brand">
          <div class="footer__logo">
            <a href="<?php echo home_url(); ?>"><img src="<?php echo get_template_directory_uri(); ?>/assets/icons/logo-main.svg" alt="AR PRIVÉ"></a>
          </div>
          <h6>Follow Us</h6>
        ...
        <div class="footer__nav-col">
          ...
          <ul class="footer__contact-list">
            ...
            <li class="footer__contact-note"><?php the_field('contact_text', 'option'); ?></li>
          </ul>
        </div>
        ...
        <?php if( $partners ): ?>
          <div class="footer__partners">
            <?php foreach( $partners as $partner_url ): ?>
              <img src="<?php echo esc_url($partner_url); ?>" alt="partner logo">
            <?php endforeach; ?>
          </div>
        <?php endif; ?>
      </div>
      ...
      <div class="footer__bottom">
        <?php
          ...
          if( $copyright ) {
            echo '<p class="footer__copyright">&copy; ' . date('Y') . ' ' . wp_kses_post($copyright) . '</p>';
          }
        ?>
      </div>
    </div>
